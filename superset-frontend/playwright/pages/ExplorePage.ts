...
/**
 * Explore Page Object
 * Encapsulates core interactions needed by migrated Cypress tests.
 * Assertions belong in spec files; this class only exposes actions & queries.
 */
export class ExplorePage {
  ...
  /** Wait for explore page core controls to be visible */
  ...
  async gotoChartList(): Promise<void> {
    await this.page.goto(CHART_LIST);
